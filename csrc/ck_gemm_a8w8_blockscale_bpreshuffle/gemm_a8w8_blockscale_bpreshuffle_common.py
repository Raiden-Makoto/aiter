...
kernels_list = {
    ...
    # Mixed scale: group-128 activation and per-channel weight scales.
    18:  kernelInstance(256,     1,     1,   128,    16,   128,   128,   8,  16,  16,   16,    1,    2,     [16, 16, 1],     [ 8, 32, 1],           1,           2,                   [1, 16, 1, 16],             [8],     "Intrawave",                  1,),
}
...
default_kernels_dict = {
    ...
    # Mixed scale runtime fallback.
    (-2):kernelInstance(256,     1,     1,   128,    16,   128,   128,   8,  16,  16,   16,    1,    2,     [16, 16, 1],     [ 8, 32, 1],           1,           2,                   [1, 16, 1, 16],             [8],     "Intrawave",                  1,),
}
# fmt: on
